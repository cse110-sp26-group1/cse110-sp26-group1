...
4. example request line like GET /invites HTTP/
5. example response
...
Purpose: Allows team admins to invite new members. Supports inviting by user ID, username, or email for flexibility.
...
Purpose: Allows invited users to join a team. Only the invited user can accept the invite.
...
Purpose: Allows users to decline team invitations they don't want to accept.
...
Purpose: Allows invite senders or team admins to cancel pending invites before they are accepted.
